...
extern "C" const AMX_NATIVE_INFO native_list[] =
{
	...
	AMX_DEFINE_NATIVE(DCC_SendInteractionMessageWithComponents)
	AMX_DEFINE_NATIVE(DCC_UpdateInteractionMessage)
	AMX_DEFINE_NATIVE(DCC_ReplyWithModal)
	AMX_DEFINE_NATIVE(DCC_DeferInteraction)
	AMX_DEFINE_NATIVE(DCC_GetInteractionCustomId)
	AMX_DEFINE_NATIVE(DCC_GetInteractionSelectedValue)
	AMX_DEFINE_NATIVE(DCC_GetInteractionSelectedValueCount)
	AMX_DEFINE_NATIVE(DCC_GetInteractionModalValue)
	AMX_DEFINE_NATIVE(DCC_DeleteCommand)
	AMX_DEFINE_NATIVE(DCC_CreateButton)
	AMX_DEFINE_NATIVE(DCC_ButtonSetLabel)
	AMX_DEFINE_NATIVE(DCC_ButtonSetStyle)
	AMX_DEFINE_NATIVE(DCC_ButtonSetEmoji)
	AMX_DEFINE_NATIVE(DCC_ButtonSetUrl)
	AMX_DEFINE_NATIVE(DCC_ButtonSetDisabled)
	AMX_DEFINE_NATIVE(DCC_DeleteButton)
	AMX_DEFINE_NATIVE(DCC_CreateSelectMenu)
	AMX_DEFINE_NATIVE(DCC_SelectMenuAddOption)
	AMX_DEFINE_NATIVE(DCC_SelectMenuSetDisabled)
	AMX_DEFINE_NATIVE(DCC_SelectMenuSetPlaceholder)
	AMX_DEFINE_NATIVE(DCC_SelectMenuSetMinValues)
	AMX_DEFINE_NATIVE(DCC_SelectMenuSetMaxValues)
	AMX_DEFINE_NATIVE(DCC_DeleteSelectMenu)
	AMX_DEFINE_NATIVE(DCC_CreateActionRow)
	AMX_DEFINE_NATIVE(DCC_ActionRowAddButton)
	AMX_DEFINE_NATIVE(DCC_ActionRowAddSelectMenu)
	AMX_DEFINE_NATIVE(DCC_DeleteActionRow)
	AMX_DEFINE_NATIVE(DCC_SendChannelMessageWithComponents)
	AMX_DEFINE_NATIVE(DCC_EditMessageWithComponents)
	AMX_DEFINE_NATIVE(DCC_CreateModal)
	AMX_DEFINE_NATIVE(DCC_ModalSetTitle)
	AMX_DEFINE_NATIVE(DCC_ModalAddTextInput)
